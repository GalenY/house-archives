...
# specifying a naming convention for database constraints, important to specify one so that Alembic's database
# migrations which involve making a modification to database constraints will work
# see: http://flask-sqlalchemy.pocoo.org/2.1/config/#using-custom-metadata-and-naming-conventions
convention = {
